...
@Component({
  ...
  templateUrl: './super-admin1.component.html',
  styleUrls: ['./super-admin1.component.css']
})
export class SuperAdmin1Component implements OnInit {
  ...
  goToAdmin1($myParam: string = ''): void {
